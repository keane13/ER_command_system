...
OLAP (Long-Term Memory): Google BigQuery
...
OLTP (Short-Term Memory): Cloud SQL (PostgreSQL)
...
git clone https://github.com/your-username/ER_command_system.git
...
Built with ❤️ and ☕ for Hack2Vision 2026 by Team AiOne.
